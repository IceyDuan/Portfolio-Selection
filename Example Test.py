...
# 数据导入
stock_code_list = ['000049.SZ','600733.SH','000969.SZ','000099.SZ','600211.SH','600165.SH','600233.SH','000012.SZ','002171.SZ','600917.SH','002049.SZ','002747.SZ','002985.SZ','002929.SZ','002414.SZ']
...
trets = np.linspace(-0.3, port_rets(opts['x']), 50)  # 生成序列范围
tvols = []
weights = []
for tret in trets:
...
# 结果导出
returns.to_excel('Example Returns.xlsx',index=True)
